import type { DashboardProject, StateOption, StatePrimitive, StateSnapshot } from "../../packages/shared/src";
export type AdapterCommand = "dashboard.load" | "dashboard.save" | "dashboard.export" | "dashboard.import" | "objects.search" | "states.read" | "state.write";
...
export type CommandPayload = LoadDashboardPayload | SaveDashboardPayload | ImportDashboardPayload | SearchObjectsPayload | ReadStatesPayload | WriteStatePayload | undefined;
